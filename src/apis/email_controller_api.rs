...
#[derive(Clone, Debug)]
pub struct DownloadBodyBytesParams {
    /// ID of email
    pub email_id: String
}
...
#[derive(Clone, Debug)]
pub struct GetAttachments1Params {
    /// ID of email
    pub email_id: String
}
...
#[derive(Clone, Debug)]
pub struct GetEmailLinksParams {
...
#[derive(Clone, Debug)]
pub struct GetGravatarUrlForEmailAddressParams {
    /// emailAddress
...
/// struct for passing parameters to the method `mark_as_read`
#[derive(Clone, Debug)]
...
#[derive(Clone, Debug)]
pub struct SendEmailSourceOptionalParams {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DownloadBodyBytesError {
    Status401(),
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetGravatarUrlForEmailAddressError {
    Status401(),
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SendEmailSourceOptionalError {
    Status401(),
    Status403(),
    Status404(),
    UnknownValue(serde_json::Value),
...
pub async fn download_body(configuration: &configuration::Configuration, params: DownloadBodyParams) -> Result<String, Error<DownloadBodyError>> {
    // unbox the parameters
    let email_id = params.email_id;
    ...
    let local_var_uri_str = format!("{}/emails/{emailId}/body", configuration.base_path, emailId=email_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
...
pub async fn download_body_bytes(configuration: &configuration::Configuration, params: DownloadBodyBytesParams) -> Result<String, Error<DownloadBodyBytesError>> {
    // unbox the parameters
    let email_id = params.email_id;
    ...
    let local_var_uri_str = format!("{}/emails/{emailId}/body-bytes", configuration.base_path, emailId=email_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadBodyBytesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn forward_email(configuration: &configuration::Configuration, params: ForwardEmailParams) -> Result<crate::models::SentEmailDto, Error<ForwardEmailError>> {
    // unbox the parameters
    let email_id = params.email_id;
...
pub async fn get_attachments1(configuration: &configuration::Configuration, params: GetAttachments1Params) -> Result<Vec<crate::models::AttachmentMetaData>, Error<GetAttachments1Error>> {
    // unbox the parameters
    let email_id = params.email_id;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAttachments1Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_email_links(configuration: &configuration::Configuration, params: GetEmailLinksParams) -> Result<crate::models::EmailLinksResult, Error<GetEmailLinksError>> {
    // unbox the parameters
    let email_id = params.email_id;
    ...
    let local_var_uri_str = format!("{}/emails/{emailId}/links", configuration.base_path, emailId=email_id);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmailLinksError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_gravatar_url_for_email_address(configuration: &configuration::Configuration, params: GetGravatarUrlForEmailAddressParams) -> Result<crate::models::GravatarUrl, Error<GetGravatarUrlForEmailAddressError>> {
    // unbox the parameters
    ...
    let local_var_uri_str = format!("{}/emails/gravatarFor", configuration.base_path);
    let mut local_var_req_builder = local_var_client.get(local_var_uri_str.as_str());

    local_var_req_builder = local_var_req_builder.query(&[("emailAddress", &email_address.to_string())]);
    if let Some(ref local_var_str) = size {
        local_var_req_builder = local_var_req_builder.query(&[("size", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGravatarUrlForEmailAddressError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn mark_as_read(configuration: &configuration::Configuration, params: MarkAsReadParams) -> Result<crate::models::EmailPreview, Error<MarkAsReadError>> {
    // unbox the parameters
    let email_id = params.email_id;
    ...
    let local_var_uri_str = format!("{}/emails/{emailId}/read", configuration.base_path, emailId=email_id);
    let mut local_var_req_builder = local_var_client.patch(local_var_uri_str.as_str());

    if let Some(ref local_var_str) = read {
        local_var_req_builder = local_var_req_builder.query(&[("read", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn send_email_source_optional(configuration: &configuration::Configuration, params: SendEmailSourceOptionalParams) -> Result<(), Error<SendEmailSourceOptionalError>> {
    // unbox the parameters
    let inbox_id = params.inbox_id;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendEmailSourceOptionalError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
